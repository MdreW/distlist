...
describe AttachmentsController do
  describe "GET show" do
    it "file" do
      ...
      get :show, {campaign_id: attachment.email.campaign.to_param, email_id: attachment.email.to_param, :id => attachment.to_param}
  ...
  describe "POST create" do
    describe "valid" do
      it "Attachment" do
        ...
        expect {
          post :create, { campaign_id: email.campaign.to_param, email_id: email.to_param, attachment: attributes_for(:attachment) }
    ...
    describe "invalid" do
      it "param" do
        ...
        post :create, {campaign_id: email.campaign.to_param, email_id: email.to_param, attachment: attributes_for(:attachment, file: nil )}
  ...
  describe "destroy" do
    it "requested attachment" do
      ...
      sign_in attachment.email.campaign.user
      expect {
        delete :destroy, {campaign_id: attachment.email.campaign.to_param, email_id: attachment.email.to_param, :id => attachment.to_param}
      }.to change(Attachment, :count).by(-1)
    end
    it "redirects" do
      attachment = create(:attachment)
