...
describe CampaignsController do
  ...
  def valid_attributes
    {:title => 'Campaign Test', :header => 'Header Test', :footer => 'Footer Test', :sender_name => 'name test', :sender_email => 'email_test@distlist.com'}
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested campaign" do
        ...
        put :update, {:id => campaign.to_param, :campaign => {'title' => 'to test'}}
      end
      it "assigns the requested campaign as @campaign" do
        user = create(:user)
        sign_in user
        campaign = create(:campaign, :user => user)
        put :update, {:id => campaign.to_param, :campaign => attributes_for(:campaign)}
        assigns(:campaign).should eq(campaign)
      end
